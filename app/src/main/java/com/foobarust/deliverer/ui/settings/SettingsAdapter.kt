...
import com.foobarust.deliverer.databinding.SettingsAccountItemBinding
import com.foobarust.deliverer.databinding.SettingsSectionItemBinding
...
import com.foobarust.deliverer.ui.settings.SettingsViewHolder.SettingsAccountViewHolder
import com.foobarust.deliverer.ui.settings.SettingsViewHolder.SettingsSectionViewHolder
...
class SettingsAdapter(
    ...
    override fun onBindViewHolder(holder: SettingsViewHolder, position: Int) {
        when (holder) {
            is SettingsAccountViewHolder -> bindProfileModel(
                binding = holder.binding,
                accountItemModel = getItem(position) as SettingsAccountItemModel
            )

            is SettingsSectionViewHolder -> bindSectionModel(
                binding = holder.binding,
    ...
    private fun bindProfileModel(
        binding: SettingsAccountItemBinding,
        accountItemModel: SettingsAccountItemModel
    ) = binding.run {
        usernameTextView.text = accountItemModel.username

        accountItemModel.photoUrl?.let {
        ...
        profileItemLayout.setOnClickListener {
            listener.onProfileClicked()
        }
    }

    private fun bindSectionModel(
